...
carro.mudarCor = function(cor){
    carro.cor = cor;
    return 'Agora o carro é ' + carro.cor + '!';
}
...
carro.adicionarPessoa = function(quantidade){
    ...
    var vagasString = vagas > 1 ? ' pessoas!' : ' pessoa!';
	var pessoaString;    

    if(!vagas){
        return "O carro está lotado!";
    } else if( quantidade > vagas){
        return "Só cabem mais " + vagas + vagasString;
    } else{
        carro.quantidadePessoas += quantidade;
    }
    
	pessoaString = carro.quantidadePessoas > 1 ? ' pessoas no carro!' : 'pessoa no carro!';

    return 'Já temos ' + carro.quantidadePessoas + pessoaString;
}
...
carro.mudarCor('vermelho'); //Agora o carro é vermelho!

// E agora, qual a cor do carro?
carro.obterCor(); //vermelho

// Mude a cor do carro para verde musgo.
carro.mudarCor('verde musgo'); //Agora o carro é verde musgo!
