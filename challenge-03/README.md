...
pessoa.andar = function(distanciaMetros){
  pessoa.caminhouQuantosMetros += distanciaMetros;
  pessoa.andando = true;
  }
...
*/
pessoa.nomeCompleto(); //Olá! Meu nome é Sérgio Gadelha!
...
// Agora, apresente-se ;)
pessoa.apresentacao(); //Olá, eu sou o Sérgio Gadelha, tenho 26 anos, 1.60, meu peso é 72 e, só hoje, eu já caminhei 10 metros!
```
