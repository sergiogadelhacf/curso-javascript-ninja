...
segundo parâmetro.
*/
function retornPosicaoArray(array, indice){
    return array[indice];
}
...
*/
var arrayDif = [true,'string',3,null,{}];

/*
Invoque a função criada acima, fazendo-a retornar todos os valores do último
array criado.
*/
retornPosicaoArray(arrayDif,0);
retornPosicaoArray(arrayDif,1);
retornPosicaoArray(arrayDif,2);
retornPosicaoArray(arrayDif,3);
retornPosicaoArray(arrayDif,4);
